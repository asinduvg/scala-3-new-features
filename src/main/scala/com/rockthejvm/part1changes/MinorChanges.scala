...
object MinorChanges {
  ...
  trait Kid extends Person // ok
  //  trait Kid_v2 extends Person("Alice") // not ok

  // solve the diamond problem
  //  trait JPerson extends Person("John")
  //  trait APerson extends Person("Alice")
  //  trait Kid_v3 extends JPerson with APerson // would be weird

  /**
   * "Universal constructor", == apply method everywhere
   */
